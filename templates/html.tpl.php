...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="https://ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/images/logos/EMBL-EBI/favicons/apple-touch-icon-114x114.png"> <!-- For iPhone 4 Retina display (114px) -->
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="https://ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/images/logos/EMBL-EBI/favicons/apple-touch-icon-72x72.png"> <!-- For iPad (72px) -->
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="https://ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/images/logos/EMBL-EBI/favicons/apple-touch-icon-144x144.png"> <!-- For iPad retinat (144px) -->
  <link rel="apple-touch-icon-precomposed" href="https://ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/images/logos/EMBL-EBI/favicons/apple-touch-icon-57x57.png"> <!-- For iPhone (57px) -->
  ...
  <!-- <meta name="ebi-localmasthead-image" content="https://ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/images/backgrounds/training-yellow-2.jpg"> -->
  <!--[if lt IE 9]>
